...
| Permission | Required | Purpose | macOS | Windows |
| --- | --- | --- | --- | --- |
| Keep Awake | Optional | Prevent sleep | ✅ | ✅ |
| Accessibility | Recommended | UI automation | ✅ | — |
| Full Disk Access | Recommended | File access | ✅ | — |
