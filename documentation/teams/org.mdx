...
- **Invite Members (Manual)**
  - Invite users individually via the **Invite Members** button through email
...
- **Batch Import**
  - Upload an organization structure file
  - Automatically send invitations to all listed members

<Frame>
  ![Batchimportmember](/images/batchimportmember.png)
</Frame>

<Frame>
  ![Batchimportwindow](/images/batchimportwindow.png)
</Frame>
